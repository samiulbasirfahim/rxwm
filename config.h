...
static const char *fonts[]          = {
    "Victor Mono:weight=160:size=11.5",
...
static char normtagsfgcolor[]       = "#CDD6F4";
...
static char *colors[][3] = {
        ...
        [SchemeTagsNorm]        = { normtagsfgcolor,    normbgcolor,        normbordercolor  }, // Tagbar left unselected {text,background,not used but cannot be empty}
...
static const Rule rules[] = {
	...
	{ "teams-for-linux",  NULL,       NULL,           1 << 7,       1,          0,          0,          0,         -1,       0 },
